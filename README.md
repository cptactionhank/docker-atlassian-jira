...
This has been made with the best intentions and current knowledge and thus it shouldn't be expected to be flawless. However you can support this repository with best-practices and other additions. Travis CI has been setup to build the Dockerfile and run acceptance tests on the Atlassian JIRA Core image to ensure it is working.
...
Acceptance tests are performed by Travis CI with Ruby using the RSpec, Capybara, and PhantomJS frameworks.
